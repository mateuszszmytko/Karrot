...
export async function scrollTo(target: HTMLElement | string, options?): Promise<void> {
    if (!options) {
...
class ScrollToManager {
    ...
    constructor(public target: HTMLElement, public options) {
            ...
            const interval = setInterval(() => {
                ...
                if (currentLocation === this.endLocation
                    ...
                    if (this.targetHash && this.targetHash !== '#' &&
                        ...
                        if (document.location.hash !== this.targetHash) {
