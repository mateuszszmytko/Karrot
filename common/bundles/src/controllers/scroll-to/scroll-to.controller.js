...
var ScrollToController = /** @class */ (function () {
    ...
    ScrollToController.prototype.kOnInit = function () {
        var _this = this;
        var targetSelector = this.element.getAttribute('href');
        if (!targetSelector) {
            return;
        }
    ...
    ScrollToController.prototype.onClick = function (e) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.hooks.doAction('beforeScroll', this.scrollTarget)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, scroll_to_1.scrollTo(this.scrollTarget)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.hooks.doAction('afterScroll', this.scrollTarget)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
